...
import 'package:jealus_ex/screens/create_profile.dart';
//*******************************************************//
...
import 'package:jealus_ex/screens/register_view.dart';
    ...
    return MaterialApp(
      ...
      home: HomeController(),
        ...
        routes: <String, WidgetBuilder>{
          ...
          '/createUserProfile': (BuildContext context) => CreateUserProfileScreen(),
        }
    );
  }
}
...
class HomeController extends HookWidget {
  ...
  Widget build(BuildContext context){
    ...
    return authControllerState != null ? HomeView() : LogInView();
  }
