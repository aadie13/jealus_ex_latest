...
class AcceptedBookingsList extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final _upcomingBookingsList = useState([]);
    final _upcomingBookingsListLoaded = useState(false);
    final _upcomingBookingsListHasData = useState(false);

    Future collectData() async {
      final upcomingBookingsList =
          await useProvider(upcomingBookingsFromDatabaseListProvider);
      print(upcomingBookingsList.length);
      if (upcomingBookingsList.isNotEmpty) {
        _upcomingBookingsList.value = upcomingBookingsList;
